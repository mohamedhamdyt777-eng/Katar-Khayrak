                          ...
                          children: [
                            ...
                            Expanded(
                              child: Text(
                                ...
                                style: TextStyle(
                                  color: _selectedDate == null ? Colors.grey : Theme.of(context).colorScheme.onSurface,
                                ),
                              ),
                            ),
                          ],
                          ...
                          children: [
                            ...
                            Expanded(
                              child: Text(
                                ...
                                style: TextStyle(
                                  color: _selectedTime == null ? Colors.grey : Theme.of(context).colorScheme.onSurface,
                                ),
                              ),
                            ),
                          ],
