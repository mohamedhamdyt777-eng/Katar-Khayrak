            ...
            children: isOrganization ? [
              Expanded(
                child: ElevatedButton.icon(
                  onPressed: () {
                    // Navigate to edit campaign or add campaign
              ...
              // Add to Cart Button (Icon only or small outlined to save space)
              Expanded(
                flex: 1,
              ...
              // Donate / Pay Button (Filled)
              Expanded(
                flex: 2,
                child: ElevatedButton(
                  onPressed: () {
                    context.push('/payment-details', extra: campaign);
                  },
                  style: ElevatedButton.styleFrom(
                    backgroundColor: AppColors.primary,
                    padding: const EdgeInsets.symmetric(vertical: 16),
